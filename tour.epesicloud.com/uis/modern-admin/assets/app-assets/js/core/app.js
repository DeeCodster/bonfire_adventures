    ...
    $(".search-input .input").on("keyup", function (e) {
      ...
      if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
        ...
        if (value != "") {
          ...
          $.getJSON($filename+"?keyword="+value+"&live_search_entities="+$(this).attr("live_search_entities"), function (
            data
          ) {
            for (var i = 0; i < data.listItems.length; i++) {
              ...
              if (
                ...
                $startList +=
                  '<li style="padding:10px;" class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' +
                  $activeItemClass +
                  '">' +
                  '<div class="d-flex justify-content-start">' +
                  '<span class="mr-75 ' +
